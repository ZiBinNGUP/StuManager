...
public class DelStuInfo extends JPanel implements ActionListener{
	...
	private JLabel labSno = new JLabel("请输入学生学号：");
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource() == txtSno||e.getSource() == delete) {
			...
			if(s.equals("")) {
				JOptionPane.showMessageDialog(this, "请输入学生学号！", "提示", JOptionPane.INFORMATION_MESSAGE);
				return ;
			}else {
				...
				try {
					...
					if(res.next()) {
						int i = JOptionPane.showConfirmDialog(this, "您确认要删除此学生吗？(包括学生基本信息、课程信息、成绩信息..)","询问",JOptionPane.YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE);
						if(i == 0) {
